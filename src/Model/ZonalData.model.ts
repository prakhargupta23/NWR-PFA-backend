...
export const ZonalData = sequelize.define(
    "ZonalData",
    {
        ...
        actualuptothemonthopenline: { type: DataTypes.STRING, allowNull: true },
        actualuptothemonthconst: { type: DataTypes.STRING, allowNull: true },
        actualuptothemonthtotal: { type: DataTypes.STRING, allowNull: true },
